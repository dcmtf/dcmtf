...
assert dataset_id in ["wiki1","pubmed", "freebase","genephene"],"Unknown dataset_id: "+str(dataset_id) #sample "wiki5" unused
...
if dataset_id in ["wiki1","wiki2","wiki3","wiki4"]:
    ...
    list_x_id = list(dict((key,value) for key, value in data_dict['matrices'].items() if key in ('X12','X22','X32','X42')).keys())
    ...
    X_meta = dict((key,value) for key, value in data_dict['metadata']['x_meta'].items() if key in ('X12','X22','X32','X42'))
    ...
    #
    list_x_id = list(dict((key,value) for key, value in data_dict['matrices'].items() if key in ('X11','X12','X13')).keys())
    list_e_id = list(dict((key,value) for key, value in data_dict['metadata']['dict_e_size'].items() if key in ('e1','e2','e3')).keys())
    #
    #list_x_id = data_dict["list_x_id"]
    #list_e_id = data_dict["list_e_id"]
    #
    ...
    #
    # X_meta = data_dict["metadata"]["x_meta"] 
    X_meta = dict((key,value) for key, value in data_dict['metadata']['x_meta'].items() if key in ('X11','X12','X13'))
    #
    G = {}
    for e_id in list_e_id:
        temp_list = []
    ...
    list_x_id = list(dict((key,value) for key, value in data_dict['matrices'].items() if key in ('X_p_pf','X_g_p')).keys())
    list_e_id = list(dict((key,value) for key, value in data_dict['metadata']['dict_e_size'].items() if key in ('p','pf','g')).keys())
    #
    #list_x_id = data_dict["list_x_id"]
    #list_e_id = data_dict["list_e_id"]
    #
    ...
    #
    # X_meta = data_dict["metadata"]["x_meta"] 
    X_meta = dict((key,value) for key, value in data_dict['metadata']['x_meta'].items() if key in ('X_p_pf','X_g_p'))
    #
    G = {}
    for e_id in list_e_id:
        temp_list = []
