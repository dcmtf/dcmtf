...
assert len(sys.argv) == 3 ,"Usage: python main_dcmtf_clust.py dataset_id abl_category"

print("cur_dir: ",os.getcwd())

dataset_id = sys.argv[1]
abl_category = sys.argv[2]
...
out_dir = "./out_clust_abl/"+abl_category+"/"+dataset_id+"/"+"version_"+data_version_name+"/"
#
